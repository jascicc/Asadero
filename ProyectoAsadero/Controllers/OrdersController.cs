...
using ProyectoAsadero.Models;

namespace ProyectoAsadero.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TableId = new SelectList(db.Tables, "TableId", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "OrderId,TableId,ProductId,Quantity,Date")] Order order)
        {
